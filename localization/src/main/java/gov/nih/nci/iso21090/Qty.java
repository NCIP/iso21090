...
public abstract class Qty extends Any implements Cloneable {
	...
	public void setUncertainty(Qty uncertainty) {
		if(uncertainty !=null ){
			if(uncertainty.getExpression()!= null || uncertainty.getUncertainty()!= null || uncertainty.getOriginalText()!= null ){
				throw new IllegalArgumentException("Expression, Uncertainty and originalText not allowed in QTY.uncertainty");
			}
		}
