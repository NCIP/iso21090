 ...
 * @param <T>
 */
public class GtsBoundedPivl<T extends Qty> extends QSet<T> implements Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GtsBoundedPivl<?>)) {
            return false;
        }

        GtsBoundedPivl<?> x = (GtsBoundedPivl<?>) o;
     ...
     */
    @Override
    public GtsBoundedPivl<T> clone() {
        return (GtsBoundedPivl<T>) super.clone();
    }
