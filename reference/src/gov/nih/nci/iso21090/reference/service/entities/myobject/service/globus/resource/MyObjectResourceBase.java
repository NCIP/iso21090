 ...
 * 
 */
public abstract class MyObjectResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(MyObjectResourceBase.class);

	private MyObjectResourceConfiguration configuration;
	...
	public MyObjectResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (MyObjectResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
