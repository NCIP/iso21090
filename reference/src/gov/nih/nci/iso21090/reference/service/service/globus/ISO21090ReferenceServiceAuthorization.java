package gov.nih.nci.iso21090.reference.service.service.globus;
 ...
 * 
 */
public class ISO21090ReferenceServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.reference.iso21090.nci.nih.gov/ISO21090ReferenceService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public ISO21090ReferenceServiceAuthorization() {
	}
