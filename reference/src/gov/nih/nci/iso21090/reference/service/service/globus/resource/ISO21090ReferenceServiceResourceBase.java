...
import gov.nih.nci.iso21090.reference.service.common.ISO21090ReferenceServiceConstants;
import gov.nih.nci.iso21090.reference.service.stubs.ISO21090ReferenceServiceResourceProperties;
import gov.nih.nci.iso21090.reference.service.service.ISO21090ReferenceServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class ISO21090ReferenceServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(ISO21090ReferenceServiceResourceBase.class);

	private ISO21090ReferenceServiceResourceConfiguration configuration;
    ...
    public ISO21090ReferenceServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((ISO21090ReferenceServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(ISO21090ReferenceServiceConstants.SERVICEMETADATA);
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((ISO21090ReferenceServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
