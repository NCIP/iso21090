 ...
 * 
 */
public class MyObjectAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://reference.iso21090.nci.nih.gov/MyObject";
	
	Map authorizationClassMap = new HashMap();
	
	
	public MyObjectAuthorization() {
	}
	...
	public void authorizeGetById(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
